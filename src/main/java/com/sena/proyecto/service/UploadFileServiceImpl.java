...
public class UploadFileServiceImpl implements IUploadFileService {
    //1. Definir un atributo estático para definir el directorio donde guardaremos los archivos
    ...
    public String copy(MultipartFile file) throws IOException {
		...
		//Mediante la clase randomUUID generaremos un aleatorio, que garantice que el nombre del archivo 
    ...
    public boolean delete(String filename) {
        ...
        //Si archivo existe y se puede leer, borrarlo y retornar true de lo contrario false
